...
extension _PackageDescription_Product {
  /// Creates a new `_PackageDescription_Product` instance
  /// based on the provided `Product`.
  /// - Parameter entry: The `Product` instance
  /// to be used for creating the new `_PackageDescription_Product`.
