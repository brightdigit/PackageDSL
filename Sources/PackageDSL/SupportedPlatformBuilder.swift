...
@resultBuilder public enum SupportedPlatformBuilder {
  ...
  /// - Returns: A partial block of `SupportedPlatforms`
  /// containing the provided `SupportedPlatform`.
  ...
  /// - Returns: A partial block of `SupportedPlatforms`
  /// containing the `SupportedPlatforms` from the provided `PlatformSet`.
  ...
  /// from an existing `SupportedPlatforms` instance.
  ///
  ...
  /// Builds a partial block of `SupportedPlatforms`
  ///  by appending one set of `SupportedPlatforms` to another.
  ///
  /// - Parameters:
  ...
  /// Builds a partial block of `SupportedPlatforms`
  /// by appending a single `SupportedPlatform`
  /// to an existing set of `SupportedPlatforms`.
  ///
  /// - Parameters:
  ///   - accumulated: The `SupportedPlatforms`
