...
public enum SwiftSettingsBuilder {
  ...
  /// by accumulating the provided `SwiftSetting` instances.
  ///
  /// - Parameters:
  ///   - accumulated: The accumulated `SwiftSetting` instances.
  ...
  /// Builds a partial block
  /// with the provided array of `SwiftSetting` instances.
  ///
  /// - Parameter first: The array of `SwiftSetting` instances
  ///  to include in the partial block.
  /// - Returns: The provided array of `SwiftSetting` instances.
  public static func buildPartialBlock(first: [SwiftSetting]) -> [SwiftSetting] {
    first
  }

  /// Builds a partial block with the `SwiftSetting` instances
  /// from the provided `SwiftSettingsConvertible` instance.
  ///
  /// - Parameter first: The `SwiftSettingsConvertible` instance
  ...
  /// Builds a partial block by accumulating the `SwiftSetting` instances
  ///  from the provided `SwiftSettingsConvertible` instance.
  ///
  /// - Parameters:
  ///   - accumulated: The accumulated `SwiftSetting` instances.
  ///   - next: The `SwiftSettingsConvertible` instance
  ///   to extract `SwiftSetting` instances from.
  /// - Returns: An array containing the accumulated `SwiftSetting` instances
  /// and the `SwiftSetting` instances
  /// extracted from the provided `SwiftSettingsConvertible` instance.
