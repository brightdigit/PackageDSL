...
extension _PackageDescription_Target {
    static func entry(_ entry: Target) -> _PackageDescription_Target {
      ...
      case .executable:
          return .executableTarget(name: entry.name, dependencies: dependencies, resources: entry.resources)
      case .regular:
        return .target(name: entry.name, dependencies: dependencies, resources: entry.resources)
